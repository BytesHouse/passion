            ...
            <div className="container mx-auto px-[20px]">
                <div className="flex justify-between items-center">
                    ...
                    <p className="text-[42px]">
                        <span className="text-red-500 font-medium">M</span>aracu
                        <span className="text-red-500 font-medium">Й</span>а
                    </p>
                    <div className="flex items-center gap-[30px]">
                        <a
                            className="text-[#696F7A] uppercase font-semibold rounded rounded-full px-[30px] py-[5px] bg-gray-300"
