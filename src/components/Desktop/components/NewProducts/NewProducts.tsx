    ...
    return (
        <div className="container mx-auto p-[20px] flex flex-col gap-[25px]">
            ...
            <ul className="flex justify-between items-stretch">
                {!loading ? products.slice(0, 4).map((product: any) => <li key={Math.random()} className={itemStyle}><img className="self-center h-[120px] max-w-[50%]" src={product.image} alt={product.id}/>
