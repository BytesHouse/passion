    ...
    return (
        <div className={cls.loading}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="200"
                 height="200" style={{shapeRendering: "auto", display: "block", background: "rgb(255, 255, 255)"}}
            ...
            <p className={cls.p}><span>Внимание!</span> <br/>Наш сайт вышел на обед и забыл вернуться. Пожалуйста, заходите позже или оставьте сообщение после сигнала... Пиииип!</p>
        </div>
    );
};
